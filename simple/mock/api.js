...
const MockAPI = (() => {
    const STORAGE_KEY = "account-login-passkey-example";
    ...
    async function registerAccount(username) {
        ...
        const exists = getAccountByUsername(
            db,
            username
        );
    ...
    async function loginAccount(username) {
        ...
        const account = getAccountByUsername(
            db,
            username
        );
    ...
    async function getPasskeys() {
        ...
        const passkeys = db.passkeys.filter(
            item =>
                item.accountId === account.id
        );
    ...
    async function setPasskeyEnabled(
        passkeyId,
        enabled
    ) {
        logRequest(
        ...
        const passkey = db.passkeys.find(
            item =>
                item.id === passkeyId &&
                item.accountId === account.id
        );
